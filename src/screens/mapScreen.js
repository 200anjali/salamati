...
//   };
  ...
  const fetchDirections = (origin, destination, waypoints, mode) => {
    const url = `https://maps.googleapis.com/maps/api/directions/json?origin=${origin}&destination=${destination}&waypoints=${waypoints}&mode=${mode}&key=AIzaSyCJ646sNct8O7v0BwnBE6MgfNeiR15_Y6Y`;
